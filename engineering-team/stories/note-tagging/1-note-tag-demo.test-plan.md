...
**ADR:** `engineering-team/decisions/0035-note-tagging-demo-ui.md`
**Date:** 2026-06-25
...
- **the plus is a distinct control** — its click must not bubble to the card's open-in-Primal handler
  (ADR 0035's load-bearing `stopPropagation`); verified with a `window.open` spy plus a positive control
