# ADR 0039: Note-tagging demo UI — shared modal + per-card trigger

> **Renumbered at merge (2026-07-12):** authored as "ADR 0035" on the `feat/note-tagging` branch,
> which diverged from `feat/community-feed` on 2026-06-24; the mainline independently assigned 0035
> to feed-inline-videos. Renumbered to 0039 (next free) when the branches merged; content unchanged.
